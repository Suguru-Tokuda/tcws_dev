...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/unishop/styles.min.css">
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/unishop/bootstrap-datepicker.css">
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/unishop/jquery.timepicker.css">
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/unishop/card.min.css">
    <!-- <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/unishop/site.css"> -->
    <!-- "vendor.min.css",
    "card.min.css",
    ...
    <!-- <link id="mainStyles" rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/unishop/styles.min.css"> -->
    <link id="mainStyles" rel="stylesheet" media-"screen" href="<?php echo base_url(); ?>assets/css/unishop.custom.min.css">
    <!-- Modernizr-->
    <script src="<?php echo base_url(); ?>assets/js/unishop/modernizr.min.js"></script>
  </head>
  <!-- Body-->
  <body>
    ...
    <script src="<?php echo base_url(); ?>assets/js/unishop/scripts.min.js"></script>
