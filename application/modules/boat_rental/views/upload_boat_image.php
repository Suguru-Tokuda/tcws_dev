...
<?php
$form_location = base_url().'boat_rental/do_upload/'.$boat_rental_id;
?>
<div class="form-panel">
  ...
  ?>
  <form action="<?= base_url().'boat_rental/create_boat/'.$boat_rental_id ?>" method="post">
...
if ($num_rows > 0) {
  ...
  <ul id="sortlist" class="list-group" style="margin-top: 30px; list-style: none;">
    ...
    foreach($query->result() as $row) {
      $delete_image_url = base_url()."/boat_rental/delete_image/".$row->id;
